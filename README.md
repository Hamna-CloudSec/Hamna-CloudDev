...
Today, I moved from navigating folders to creating and viewing files. I practiced making empty files and reading their content without leaving the terminal.
...
| **ls -la** | Show Hidden | Shows all files, including hidden system "dotfiles". |

### 📝 Day 2 Notes:
* Used `echo "text" > file.txt` to populate files without an editor.
* Learned that `ls -la` reveals hidden configuration files.
* **Practice Task:** Created `hello.txt`, added text with `echo`, and viewed it with `cat`.
...
I officially started my journey using the Ubuntu terminal to navigate my computer without a mouse.

### Commands Mastered:
| Command | Action | What it does (In plain English) |
| :--- | :--- | :--- |
| **pwd** | Print Working Directory | Tells me exactly where I am in the folder system. |
| **ls** | List | Shows me all the files and folders inside my current location. |
...
### 📝 Day 1 Notes:
* The terminal is **case-sensitive** (e.g., `Documents` is different from `documents`).
